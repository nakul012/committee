"""
Django settings for committee_module project.
...
SECRET_KEY = 'django-insecure-r!@v!$yyulqh+_g(t@9h1mona7pov)7z3woy$(ax6r211e(t4*'
...
THIRD_PARTY_APP = ["rest_framework", "oauth2_provider", "corsheaders"]
...
ROOT_URLCONF = 'committee_module_ops.urls'
...
WSGI_APPLICATION = 'committee_module_ops.wsgi.application'
